        ...
        area(creation)
        {
            action(Approvals)
            {
                ...
                begin
                    ...
                    ApprovalEntries.SetRecordfilters(Database::"File Movement Header", 25, Rec."No.");
                    ApprovalEntries.Run;
                end;
            }
            action("Send Approval Request")
            {
                ...
                begin
                    ...
                    //cc//if ApprovalsMgmt.CheckFileMovementApprovalsWorkflowEnabled(Rec) then
                    //cc//ApprovalsMgmt.OnSendFileMovementForApproval(Rec);
                end;
            }
