...
Page 56013 "Rejected Copyright Reg List"
{
    ApplicationArea = Basic;
    Caption = 'Rejected Copyright Registration';
            ...
            group(Print)
            {
                ...
                action(Approval)
                {
                    ...
                    begin
                     ...
                     //cc//   ApprovalEntries.SetRecordfilters(Database::Table53019, DocumentType, Rec."No.");
                        ApprovalEntries.Run;
                    end;
                }
