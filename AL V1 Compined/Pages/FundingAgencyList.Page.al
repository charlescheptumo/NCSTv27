...
Page 65041 "Funding Agency List"
{
        ...
        area(processing)
        {
            ...
            group("Request Approval")
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    begin
                        //cc//if ApprovalsMgmt.CheckCustomerApprovalsWorkflowEnabled(Rec) then
                        //cc//ApprovalsMgmt.OnSendCustomerForApproval(Rec);
                    end;
                }
    ...
    begin
        ...
        //cc//    CurrPage."Power BI Report FactBox".Page.SetNameFilter(CurrPage.Caption);
        //cc//  CurrPage."Power BI Report FactBox".Page.SetContext(CurrPage.ObjectId(false));
        //cc//    PowerBIVisible := SetPowerBIUserConfig.SetUserConfig(PowerBIUserConfiguration, CurrPage.ObjectId(false));
    end;

    var
       //cc//     PowerBIUserConfiguration: Record "Power BI User Configuration";
        ApprovalsMgmt: Codeunit "Approvals Mgmt.";
         //cc//   SetPowerBIUserConfig: Codeunit "Set Power BI User Config";
    ...
    begin
        //cc//  SocialListeningMgt.GetCustFactboxVisibility(Rec, SocialListeningSetupVisible, SocialListeningVisible);
    end;

    local procedure SetCustomerNoVisibilityOnFactBoxes()
    begin
        //cc// CurrPage.SalesHistSelltoFactBox.Page.SetCustomerNoVisibility(false);
        //cc// CurrPage.SalesHistBilltoFactBox.Page.SetCustomerNoVisibility(false);
        //cc// CurrPage.CustomerDetailsFactBox.Page.SetCustomerNoVisibility(false);
        //cc// CurrPage.CustomerStatisticsFactBox.Page.SetCustomerNoVisibility(false);
    end;
