...
Page 56012 "Approved Copyright Reg List"
{
    ApplicationArea = Basic;
    Caption = 'Approved Copyright Registration';
    CardPageID = "App. Copyright Application";
    DeleteAllowed = false;
    Editable = true;
    InsertAllowed = false;
    ModifyAllowed = false;
            ...
            group(Print)
            {
                ...
                action(Approval)
                {
                    ...
                    begin
                        ...
                        ApprovalEntries.SetRecordfilters(Database::"Copyright Registration Table", DocumentType, Rec."No.");
                        ApprovalEntries.Run;
                    end;
                }
    ...
    var
        ...
        Text008: label 'Status must be open';
        Text009: label 'what';
}
