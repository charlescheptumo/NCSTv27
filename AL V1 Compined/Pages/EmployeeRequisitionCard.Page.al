...
Page 69236 "Employee Requisition Card"
{
        ...
        area(navigation)
        {
                    ...
                    begin
                        ...
                        if HREmailParameters.Find('-') then begin
                            repeat
                                ...
                                BODY := 'Dear' + ' ' + HREmp."First Name" + ' ' + HREmp."Last Name" + ',';
                                BODY := BODY + ' ' + HREmailParameters.Body + ' ' + Rec."Job Title" + ' ' + HREmailParameters."Body 2" + ' ' + Format(Rec."Closing Date") + '. ';
                                BODY := BODY + ' ' + HREmailParameters."Body 3";
                                ///    SMTP.Send();
                                emailmessage.create(HREmp."Company E-Mail", 'NACOSTI JOB APPLICATIONS', BODY);
            ...
            group("Request Approval")
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    trigger OnAction()
                    begin
                        ////cc//if ApprovalsMgmt.CheckSalesApprovalsWorkflowEnabled(Rec) THEN
                        ////cc//ApprovalsMgmt.OnSendSalesDocForApproval(Rec);
    ...
    begin
        ...
        IF Positions.FINDSET() THEN
          "Job Description":=Positions."Job Description";
