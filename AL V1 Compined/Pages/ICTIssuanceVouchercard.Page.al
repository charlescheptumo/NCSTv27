...
Page 56136 "ICT Issuance Voucher card"
{
    ...
    begin
        ...
        */
        ...
        Issuancevisibility := false;
        UserSetup.Get(UserId);
        if UserSetup."ICT Officer" = true then
            Issuancevisibility := true;
