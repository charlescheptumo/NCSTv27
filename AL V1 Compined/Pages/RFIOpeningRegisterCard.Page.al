...
Page 75343 "RFI Opening Register Card"
{
    PageType = Card;
        ...
        area(content)
        {
            group(General)
            {
                ...
                field(Description; Rec.Description)
                {
                    ...
                    trigger OnValidate()
                    begin
                        Rec.Description := Rec."Tender Name";
                    end;
                }
            ...
            {
                SubPageLink = "RFI Document No." = field("IFS Code"),
    ...
    actions
    {
        area(processing)
        {
            group(ActionGroup30)
            {
                ...
                action("Opening Report Per Supplier")
                {
                    ApplicationArea = Basic;
                    Image = WIPEntries;
                    Promoted = true;
                ...
                action("Opening Report Per Category")
                {
                    ApplicationArea = Basic;
                    Image = WIPEntries;
                    Promoted = true;
                    ...
                    begin
                        RFIResponse.Reset;
                        RFIResponse.SetRange("RFI Document No.", Rec."IFS Code");
                        Report.Run(70050, true, true, RFIResponse);
                    end;
                }
                action(Post)
                {
    ...
    begin
        ...
        Rec."Opening Type" := Rec."opening type"::IFP;
    end;
