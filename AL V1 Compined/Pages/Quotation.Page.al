...
Page 70026 Quotation
{
    ...
    layout
    {
        area(content)
        {
            ...
            part(Control25; "Bid Opening Register Line2")
            {
                SubPageLink = "Requisition No" = field(No);
            }
        }
            ...
            group("Request for Quotation")
            {
                ...
                action("Select Suppliers")
                {
                    ...
                    begin
                        ...
                        selectsuppliersrec.SetFilter("Fiscal Year", '%1|%2', PurchSetup."Prequalification start", PurchSetup."Prequalification end");
                        ...
                        if supplierrec.FindSet then begin
                            repeat
                                ...
                                if Supplierrec2.FindSet then begin
                                    ...
                                    Window.Open('Emailing Quotation to Suppliers....');
                                    WindowisOpen := true;
                                    ...
                                    emailhdr := 'REQUEST FOR QUOTATION: ' + supplierrec.Name;
                                    ...
                                    //  emailcu.Send;
                                    BODY := emailbody;
                                    EMAILMESSAGE.Create(supplierrec."E-mail", 'REQUEST FOR QUOTATION: ' + supplierrec.Name, BODY);
                ...
                if UserSetup.Get(UserId) then begin
                 ...
                 //   FileName := FileMangement.ServerTempFileName('.pdf');         //FileName:='Payslip.pdf';
                    ...
                    if SupplierSelect2.Find('-') then
                        ...
                        //   SMTPMail.Send;
                        body := Body + '<br><br><b>Note:</b> This is a system generated email, please do not reply.';
