...
Page 70147 "Evaluation Open Tender"
{
    DeleteAllowed = false;
    PageType = Card;
    ...
    actions
    {
        area(navigation)
        {
            group("Request for Quotation")
            {
                        ...
                        if supplierrec.FindSet then begin
                            repeat
                                ...
                                if Supplierrec2.FindSet then begin
                                    ...
                                    // emailcu.Send;
                                    BODY := 'Dear ' + supplierrec.Name + '<br><br>' +
                                    'Please Find Attached Request for Quotation and Terms of Reference<br><br>' +
                                    'Please apply through the Portal<br><br>' +
                                    'Kind Regards<br><br>';
                ...
                action("Evaluation Commitee Members")
                {
                    ApplicationArea = Basic;
                    Image = Resource;
                    Promoted = true;
                    ...
                    RunPageLink = "Appointment No" = field("Evaluation Committee");
                }
            ...
            group("Request Approval")
            {
                ...
                {
                    ApplicationArea = Basic;
                    Caption = 'Start Technical Evaluation';
                    Image = Bin;
                    Promoted = true;
                    PromotedCategory = Process;
                    PromotedIsBig = true;
                    RunObject = Page "Tender Bids T";
                    RunPageLink = "Requisition No" = field(No);
                    Visible = openingbl3;
                ...
                {
                    ApplicationArea = Basic;
                    Caption = 'Start Financial Evaluation';
                    Image = Bin;
                    Promoted = true;
                    PromotedCategory = Process;
                    PromotedIsBig = true;
                    RunObject = Page "Tender Bids F";
                    RunPageLink = "Requisition No" = field(No);
                    Visible = openingbl4;
