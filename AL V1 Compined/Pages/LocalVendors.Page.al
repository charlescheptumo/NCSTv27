...
Page 75018 "Local Vendors"
{
        ...
        area(processing)
        {
            ...
            action(ApplyTemplate)
            {
                ...
                begin
                    ...
                    //c// MiniVendorTemplate.UpdateVendorsFromTemplate(Vendor);
                end;
            }
            action(PayVendor)
            {
    ...
    begin
        //c//   if SocialListeningSetupVisible then
        //c//     SocialListeningMgt.GetVendFactboxVisibility(Rec, SocialListeningSetupVisible, SocialListeningVisible);
    ...
    trigger OnOpenPage()
    var
    //c//  //SocialListeningSetup: Record "Social Listening Setup";
    begin
        Rec.SetFilter(Rec."Date Filter", '..%1', WorkDate);
        //c//   SocialListeningSetupVisible := SocialListeningSetup.Get and SocialListeningSetup."Show on Customers" and SocialListeningSetup."Accept License Agreement" and (SocialListeningSetup."Solution ID" <> '');
    ...
    begin
        //c//    CurrPage.VendorDetailsFactBox.Page.SetVendorNoVisibility(false);
        //c//   CurrPage.VendorHistBuyFromFactBox.Page.SetVendorNoVisibility(false);
        //c//  CurrPage.VendorHistPayToFactBox.Page.SetVendorNoVisibility(false);
        //c//  CurrPage.VendorStatisticsFactBox.Page.SetVendorNoVisibility(false);
    end;
}
