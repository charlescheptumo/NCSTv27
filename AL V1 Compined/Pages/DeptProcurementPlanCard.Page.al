...
Page 75190 "Dept Procurement Plan Card"
{
        ...
        area(processing)
        {
            ...
            group("F&unctions")
            {
                ...
                action("Copy Procurement Plan")
                {
                    ...
                    //cc//  //RunObject =Report UnknownReport57022;
                }
            ...
            group("Request Approval")
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    var
                        ApprovalsMgmt: Codeunit "Approvals Mgmt.";
                    begin
                        //cc//if ApprovalsMgmt.CheckProcPlanApprovalPossible(Rec) then
                        //cc//ApprovalsMgmt.OnSendProcPlanForApproval(Rec);
    ...
    var
        ProcPlanItem: Record "Procurement Plan 1";
