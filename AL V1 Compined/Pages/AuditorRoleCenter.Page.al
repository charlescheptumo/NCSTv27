...
Page 90000 "Auditor Role Center"
{
        ...
        area(sections)
        {
            group(Journals)
            {
                ...
                action("Intrastat Journals")
                {
                    ...
                    Image = "Report";
                    //cc//     //RunObject = Page "Intrastat Jnl. Batches";                    ToolTip = 'Summarize the value of your purchases and sales with business partners in the EU for statistical purposes and prepare to send it to the relevant authority.';
                }
            }
            group("Fixed Assets")
            {
