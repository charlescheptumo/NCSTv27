...
Page 75020 "Prequalified Vendors"
{
        ...
        area(navigation)
        {
            ...
            group(History)
            {
                ...
                action("Item &Tracking Entries")
                {
                    ...
                    begin
                //cc//          ItemTrackingDocMgt.ShowItemTrackingForMasterData(2, Rec."No.", '', '', '', '', '');
                    end;
                }
            }
        }
        ...
        area(processing)
        {
            group("Request Approval")
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    begin
                        //cc//if ApprovalsMgmt.CheckVendorApprovalsWorkflowEnabled(Rec) then
                        //cc//ApprovalsMgmt.OnSendVendorForApproval(Rec);
                    end;
                }
            ...
            action(ApplyTemplate)
            {
                ...
                //cc//      MiniVendorTemplate: Record "Mini Vendor Template";
                begin
                    CurrPage.SetSelectionFilter(Vendor);
               //cc//       MiniVendorTemplate.UpdateVendorsFromTemplate(Vendor);
                end;
            }
            action(PayVendor)
            {
            ...
            group(Display)
            {
                ...
                action(ReportFactBoxVisibility)
                {
                    ...
                    begin
                        ...
                        //cc//    CurrPage."Power BI Report FactBox".Page.SetFactBoxVisibility(PowerBIVisible);
                    end;
                }
            }
            group(OCR)
    ...
    var
    //cc//SocialListeningMgt: Codeunit "Social Listening Management";

    begin
      //cc//    if SocialListeningSetupVisible then
           //cc//   SocialListeningMgt.GetVendFactboxVisibility(Rec, SocialListeningSetupVisible, SocialListeningVisible);
      ...
      //cc//  CurrPage."Power BI Report FactBox".Page.SetCurrentListSelection(Rec."No.", false, PowerBIVisible);
    end;

    trigger OnInit()
    begin
        SetVendorNoVisibilityOnFactBoxes;
    //cc//        CurrPage."Power BI Report FactBox".Page.InitFactBox(CurrPage.ObjectId(false), CurrPage.Caption, PowerBIVisible);
    end;

    trigger OnOpenPage()
    var
    //SocialListeningSetup: Record "Social Listening Setup";    //SocialListeningSetup: Record "Social Listening Setup";
    begin
        Rec.SetFilter(Rec."Date Filter", '..%1', WorkDate);
     //cc//   SocialListeningSetupVisible := SocialListeningSetup.Get and SocialListeningSetup."Show on Customers" and SocialListeningSetup."Accept License Agreement" and (SocialListeningSetup."Solution ID" <> '');
    ...
    begin
      //cc//    CurrPage.VendorDetailsFactBox.Page.SetVendorNoVisibility(false);
      //cc//    CurrPage.VendorHistBuyFromFactBox.Page.SetVendorNoVisibility(false);
       //cc//   CurrPage.VendorHistPayToFactBox.Page.SetVendorNoVisibility(false);
       //cc//   CurrPage.VendorStatisticsFactBox.Page.SetVendorNoVisibility(false);
    end;
}
