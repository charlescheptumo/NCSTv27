...
Page 50057 "Approved Store Requisition"
{
            ...
            group("O&rder")
            {
                ...
                action(Approvals)
                {
                    ...
                    begin
                        ...
                        ApprovalEntries.SetRecordfilters(DATABASE::"Purchase Header",13,"No.");
                        ApprovalEntries.RUN;*/
                            ...
                            if Rec."Requisition Type" = Rec."requisition type"::Project then begin
                                ...
                                if RequisitionLine.Find('-') then begin
                                    repeat
                                        ...
                                        JobJnlLine."Dimension Set ID" := Rec."Dimension Set ID";
                                        JobJnlLine.Validate(JobJnlLine."Dimension Set ID");
                                ...
                                if RequisitionLine.Find('-') then begin
                                    repeat
                                        ...
                                        ItemGnl."Dimension Set ID" := Rec."Dimension Set ID";
            ...
            group(Print)
            {
                ...
                action("&Print")
                {
                    ...
                    begin
                        ...
                        PaymentH.Reset;
                        PaymentH.SetRange("No.", Rec."No.");
                        Report.Run(70009, true, true, PaymentH);
                    end;
                }
            }
        }
    ...
    var
        ...
        PaymentH: Record "Purchase Header";

    local procedure Posts(PostingCodeunitID: Integer)
    begin
