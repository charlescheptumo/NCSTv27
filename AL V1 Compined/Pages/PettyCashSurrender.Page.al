    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Applied to Doc No"; Rec."Applied to Doc No")
                {
                    ApplicationArea = Basic;
                }
        ...
        area(navigation)
        {
            group("Payment Voucher")
            {
                ...
                action(Approvals)
                {
                    ...
                    begin
                        /*
                        ApprovalEntries.SetRecordfilters(DATABASE::Payments,7,"No.");
                        ApprovalEntries.RUN;*/
            ...
            group(Print)
            {
                ...
                action(DocAttach1)
                {
                    ...
                    begin
                        ...
                        */
                        //DMSManagement.UploadPettyCashSurrenderDoc(Rec."No.", 'Petty Cash Surrender', Rec.RecordId)
