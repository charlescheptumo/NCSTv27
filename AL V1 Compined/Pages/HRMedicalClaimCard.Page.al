            ...
            group("&Functions")
            {
                ...
                action(Post)
                {
                    ...
                    begin
                        ...
                        Rec.TestField(Rec."Claim Date");
                        Rec.TestField(Rec."Amount Claimed");
                ...
                action("Send A&pproval Request")
                {
                    ...
                    begin
                        ...
                        /*
                        //cc//if ApprovalsMgmt.CheckImprestRequisitionApprovalsWorkflowEnabled(Rec) THEN
                          //cc//ApprovalsMgmt.OnSendImprestRequisitionForApproval(Rec);
                        */
