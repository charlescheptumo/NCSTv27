...
Page 75045 "IFP Card"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    Caption = 'Tender Document Number';
                }
                field("Period Start Date"; Rec."Period Start Date")
                {
                    ApplicationArea = Basic;
                    Caption = 'Registration Period Existence Start Date';
                }
                field("Period End Date"; Rec."Period End Date")
                {
                    ApplicationArea = Basic;
                    Caption = 'Registration Period Existence End Date';
                    Visible = true;
                }
            ...
            group(IFP)
            {
                ...
                action(DocAttach2)
                {
                    ...
                    begin
                        ...
                        //DMSManagement.UploadFilesPrequalificationDocs(Rec.Code, 'IFP', Rec.RecordId);
                    end;
                }
                action(DocAttach1)
                {
    ...
    begin
        //"Document Type":="Document Type"::"Invitation For Prequalification";
        //"Document Type":="Document Type"::"Invitation For Registration";
