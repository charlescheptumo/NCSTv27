...
Page 65137 "Finance Role Center"
{
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            {
                //cc//   AccessByPermission = TableData "Assisted Setup" = R;
                ApplicationArea = Basic, Suite;
    ...
    actions
    {
            ...
            group(ActionGroup60)
            {
               ...
               //cc//     RunObject = Report "Intrastat - Checklist";
                ...
                action("Intrastat - For&m")
                {
                    ...
                    Image = "Report";
                    //cc//    RunObject = Report "Intrastat - Form";
        ...
        area(embedding)
        {
            ...
            action(Intrastat)
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Intrastat';
                //RunObject = Page "Intrastat Jnl. Batches";                ToolTip = 'Report your trade with other EU countries/regions for Intrastat reporting.';
            }
        }
        area(sections)
        {
            group(Finance)
            {
                ...
                action("Intrastat Journals")
                {
                    ...
                    Promoted = true;
                    PromotedCategory = Process;
                    //RunObject = Page "Intrastat Jnl. Batches";                    ToolTip = 'Summarize the value of your purchases and sales with business partners in the EU for statistical purposes and prepare to send it to the relevant authority.';
                }
