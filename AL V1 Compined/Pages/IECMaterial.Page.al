...
Page 50088 "IEC Material"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group("Price & Posting")
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    CaptionClass = '2,0,' + Rec.FIELDCAPTION(Rec."Unit Price");
                    Importance = Additional;
        ...
        area(processing)
        {
            ...
            group("F&unctions")
            {
                ...
                action(ApplyTemplate)
                {
                    ...
                    begin
                        //cc//       ItemTemplate.UpdateItemFromTemplate(Rec);
                    end;
                }
                action(SaveAsTemplate)
                {
                    ...
                    trigger OnAction()
                    var
                        TempItemTemplate: Record "Item Templ.";
                    begin
                        //    TempItemTemplate. (Rec);
                    end;
                }
            }
    ...
    begin
        //ccocialListeningMgt.GetItemFactboxVisibility(   Rec, SocialListeningSetupVisible, SocialListeningVisible);
    end;
    ...
    begin
        if NewMode then begin
            //cc//    if ItemTemplate.NewItemFromTemplate(Item) then begin
            Rec.Copy(Item);
            CurrPage.Update;
            //cc//   end;
