...
Page 56091 "Escalated Complaints Card"
{
    ...
    actions
    {
        area(creation)
        {
            ...
            action("Submit Complaint")
            {
                ...
                trigger OnAction()
                begin
                    Rec.TestField(Rec."Solution Remarks");
    ...
    begin
        ...
        BODY := 'Dear ' + EName + ',' + ' The complaint of ' + Rec."Received From" + ' ' + Rec."Case Description" + ' has been resolved on '
         + Format(Today) + '. Kindly proceed to close it.';

        //  notifymail.Send;
        EMAILMESSAGE.Create(UserEmail, 'UTAP Notification', BODY);
