    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(ArrEarnings_1_Number_; ArrEarnings[1, Integer.Number])
                {
                }
                column(ArrEarningsAmt_1_Number_; ArrEarningsAmt[1, Integer.Number])
                {
                }
                column(BalanceArray_1_Number_; BalanceArray[1, Integer.Number])
                {
                }
                column(ArrHeadings; ArrHeadings[Integer.Number])
                {
                }
            ...
            begin
                ...
                if DirectorLedgerEntry.Find('-') then begin
                    ...
                    DirectorLedgerEntry.CalcSums(Amount);
                    ArrEarnings[1, i] := DirectorLedgerEntry.Description;
               ...
               Earn.SETRANGE(Earn."Non-Cash Benefit",TRUE);
                ...
                IF DirectorLedgerEntry.FIND('-') THEN BEGIN
                 ...
                 PAYE:=DirectorLedgerEntry.Amount;
              ...
              // Taxable amount
                ...
                */
                ...
                i := i + 1;
                ArrEarnings[1, i] := 'Board Member Details';
                j := j + 1;
                ArrHeadings[i] := j;
                ...
                //Vendor.CALCFIELDS("Bank Branch","Vendor's Bank");...//commented by Morris

                ArrEarnings[1, i] := 'Board Members Bank';
                ArrEarningsAmt[1, i] := Vendor."Bank Branch";

                i := i + 1;
                ArrEarnings[1, i] := 'Bank Branch';
                ArrEarningsAmt[1, i] := Vendor."Vendor's Bank";
