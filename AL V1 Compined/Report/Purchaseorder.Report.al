...
Report 59001 "Purchase order"
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(PMTitle; PMTitle)
            {
            }
            column(CMTitle; CMTitle)
            {
            }
            dataitem(CopyLoop; "Integer")
            {
                        ...
                        begin
                            ...
                            repeat
                                ...
                                if DimText = '' then begin
                                    DimSetEntry1.CalcFields("Dimension Value Name");
                                    DimText := StrSubstNo('%1 %2', DimSetEntry1."Dimension Code", DimSetEntry1."Dimension Value Name");
                                end
                                else begin
                                    DimSetEntry1.CalcFields("Dimension Value Name");
                                    DimText := StrSubstNo('%1, %2 %3', DimText, DimSetEntry1."Dimension Code", DimSetEntry1."Dimension Value Name");
                                end;
                        ...
                        dataitem(DimensionLoop2; "Integer")
                        {
                            ...
                            begin
                                ...
                                repeat
                                    OldDimText := DimText;
                                    if DimText = '' then begin
                                        DimSetEntry2.CalcFields("Dimension Value Name");
                                        DimText := StrSubstNo('%1 %2', DimSetEntry2."Dimension Code", DimSetEntry2."Dimension Value Name")
                                    end
                                    else begin
                                        DimSetEntry2.CalcFields("Dimension Value Name");
                                        DimText := StrSubstNo('%1, %2 %3', DimText, DimSetEntry2."Dimension Code", DimSetEntry2."Dimension Value Name");
                                    end;
                                    if StrLen(DimText) > MaxStrLen(OldDimText) then begin
                                        DimText := OldDimText;
                                        Continue := true;
                        ...
                        dataitem(PrepmtDimLoop; "Integer")
                        {
                            ...
                            begin
                                ...
                                repeat
                                    OldDimText := DimText;
                                    if DimText = '' then
                                        DimText := StrSubstNo('%1 %2', PrepmtDimSetEntry."Dimension Code", PrepmtDimSetEntry."Dimension Value Name")
                                    else
                                        DimText :=
                                          StrSubstNo(
                                            '%1, %2 %3', DimText,
                                            PrepmtDimSetEntry."Dimension Code", PrepmtDimSetEntry."Dimension Value Name");
                                    if StrLen(DimText) > MaxStrLen(OldDimText) then begin
                                        DimText := OldDimText;
                                        Continue := true;
                                        exit;
                ...
                begin
                    ...
                    //cc//           PurchPostPrepmt.BuildInvLineBuffer2("Purchase Header", PrepmtPurchLine, 0, PrepmtInvBuf);
            ...
            trigger OnAfterGetRecord()
            begin
                //cc//          CurrReport.Language := Language.GetLanguageID("Purchase Header"."Language Code");
    ...
    requestpage
    {
        ...
        trigger OnOpenPage()
        begin
            //cc//        //ArchiveDocument := PurchSetup."Archive Quotes and Orders";
            //cc//LogInteraction :=SegManagement.FindInteractTmplCode(13) <> '';
