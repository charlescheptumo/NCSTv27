...
Report 65008 "Grantor Statement"
{
    RDLCLayout = './Layouts/GrantorStatement.rdlc';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(CustLedgEntryHdr; "Integer")
                    {
                        ...
                        dataitem(DtldCustLedgEntries; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            column(PostDate_DtldCustLedgEntries; Format(DtldCustLedgEntries."Posting Date"))
                            {
                            }
                            column(DocNo_DtldCustLedgEntries; DtldCustLedgEntries."Document No.")
                            {
                            }
                            ...
                            column(CurrCode_DtldCustLedgEntries; DtldCustLedgEntries."Currency Code")
                            {
                            }
                            column(Amt_DtldCustLedgEntries; DtldCustLedgEntries.Amount)
                            {
                            ...
                            begin
                                if SkipReversedUnapplied(DtldCustLedgEntries) or (DtldCustLedgEntries.Amount = 0) then
                                    CurrReport.Skip;
                                RemainingAmount := 0;
                                PrintLine := true;
                                case DtldCustLedgEntries."Entry Type" of
                                    DtldCustLedgEntries."entry type"::"Initial Entry":
                                        begin
                                            CustLedgerEntry.Get(DtldCustLedgEntries."Cust. Ledger Entry No.");
                                    ...
                                    DtldCustLedgEntries."entry type"::Application:
                                        begin
                                            DetailedCustLedgEntry2.SetCurrentkey("Customer No.", "Posting Date", "Entry Type");
                                            DetailedCustLedgEntry2.SetRange("Customer No.", DtldCustLedgEntries."Customer No.");
                                            DetailedCustLedgEntry2.SetRange("Posting Date", DtldCustLedgEntries."Posting Date");
                                            DetailedCustLedgEntry2.SetRange("Entry Type", DtldCustLedgEntries."entry type"::Application);
                                            DetailedCustLedgEntry2.SetRange("Transaction No.", DtldCustLedgEntries."Transaction No.");
                                            DetailedCustLedgEntry2.SetFilter("Currency Code", '<>%1', DtldCustLedgEntries."Currency Code");
                                    ...
                                    DtldCustLedgEntries."entry type"::"Payment Discount",
                                    DtldCustLedgEntries."entry type"::"Payment Discount (VAT Excl.)",
                                    DtldCustLedgEntries."entry type"::"Payment Discount (VAT Adjustment)",
                                    DtldCustLedgEntries."entry type"::"Payment Discount Tolerance",
                                    DtldCustLedgEntries."entry type"::"Payment Discount Tolerance (VAT Excl.)",
                                    DtldCustLedgEntries."entry type"::"Payment Discount Tolerance (VAT Adjustment)":
                                        begin
                                            Description := PaymentDiscountLbl;
                                            DueDate := 0D;
                                        end;
                                    DtldCustLedgEntries."entry type"::"Payment Tolerance",
                                    DtldCustLedgEntries."entry type"::"Payment Tolerance (VAT Excl.)",
                                    DtldCustLedgEntries."entry type"::"Payment Tolerance (VAT Adjustment)":
                                        begin
                                            Description := WriteoffsLbl;
                                            DueDate := 0D;
                                        end;
                                    DtldCustLedgEntries."entry type"::"Appln. Rounding",
                                    DtldCustLedgEntries."entry type"::"Correction of Remaining Amount":
                                        begin
                                ...
                                CustBalance := CustBalance + DtldCustLedgEntries.Amount;
                            ...
                            begin
                                DtldCustLedgEntries.SetRange(DtldCustLedgEntries."Customer No.", Customer."No.");
                                DtldCustLedgEntries.SetRange(DtldCustLedgEntries."Posting Date", StartDate, EndDate);
                                DtldCustLedgEntries.SetRange(DtldCustLedgEntries."Currency Code", TempCurrency2.Code);
                    ...
                    dataitem(OverdueVisible; "Integer")
                    {
                        ...
                        dataitem(CustLedgEntry2; "Cust. Ledger Entry")
                        {
                            ...
                            column(RemainAmt_CustLedgEntry2; CustLedgEntry2."Remaining Amount")
                            {
                                AutoFormatExpression = "Currency Code";
                                AutoFormatType = 1;
                            }
                            column(PostDate_CustLedgEntry2; Format(CustLedgEntry2."Posting Date"))
                            {
                            }
                            column(DocNo_CustLedgEntry2; CustLedgEntry2."Document No.")
                            {
                            }
                            column(Desc_CustLedgEntry2; CustLedgEntry2.Description)
                            {
                            }
                            column(DueDate_CustLedgEntry2; Format(CustLedgEntry2."Due Date"))
                            {
                            }
                            column(OriginalAmt_CustLedgEntry2; CustLedgEntry2."Original Amount")
                            {
                                AutoFormatExpression = "Currency Code";
                            }
                            column(CurrCode_CustLedgEntry2; CustLedgEntry2."Currency Code")
                            {
                            }
                            ...
                            column(CustNo_CustLedgEntry2; CustLedgEntry2."Customer No.")
                            {
                            }
                            ...
                            begin
                                if IncludeAgingBand then
                                    if (CustLedgEntry2."Posting Date" > EndDate) and (CustLedgEntry2."Due Date" >= EndDate) then
                                        CurrReport.Skip;
                                CustLedgEntry := CustLedgEntry2;
                                CustLedgEntry.SetRange("Date Filter", 0D, EndDate);
                                CustLedgEntry.CalcFields("Remaining Amount");
                                CustLedgEntry2."Remaining Amount" := CustLedgEntry."Remaining Amount";
                                if CustLedgEntry."Remaining Amount" = 0 then
                                    CurrReport.Skip;

                                if CustLedgEntry2."Due Date" >= EndDate then
                                    CurrReport.Skip;
                            ...
                            begin
                                if not IncludeAgingBand then
                                    CustLedgEntry2.SetRange(CustLedgEntry2."Due Date", 0D, EndDate - 1);
                                CustLedgEntry2.SetRange(CustLedgEntry2."Currency Code", TempCurrency2.Code);
                ...
                dataitem(AgingBandVisible; "Integer")
                {
                    ...
                    dataitem(AgingCustLedgEntry; "Cust. Ledger Entry")
                    {
                        ...
                        var
                            CustLedgEntry: Record "Cust. Ledger Entry";
                        begin
                            if (AgingCustLedgEntry."Posting Date" > EndDate) and (AgingCustLedgEntry."Due Date" >= EndDate) then
                                CurrReport.Skip;
                            if DateChoice = Datechoice::"Due Date" then
                                if AgingCustLedgEntry."Due Date" >= EndDate then
                                    CurrReport.Skip;
                            CustLedgEntry := AgingCustLedgEntry;
                            CustLedgEntry.SetRange("Date Filter", 0D, EndDate);
                            CustLedgEntry.CalcFields("Remaining Amount");
                            AgingCustLedgEntry."Remaining Amount" := CustLedgEntry."Remaining Amount";
                            if CustLedgEntry."Remaining Amount" = 0 then
                                CurrReport.Skip;

                            if AgingCustLedgEntry."Posting Date" <= EndDate then
                                UpdateBuffer(AgingCustLedgEntry."Currency Code", GetDate(AgingCustLedgEntry."Posting Date", AgingCustLedgEntry."Due Date"), AgingCustLedgEntry."Remaining Amount");
                        end;

                        trigger OnPreDataItem()
                        begin
                            Customer.Copyfilter("Currency Filter", AgingCustLedgEntry."Currency Code");
                            AgingCustLedgEntry.SetCurrentkey(AgingCustLedgEntry."Customer No.", AgingCustLedgEntry."Posting Date", AgingCustLedgEntry."Currency Code");
                            AgingCustLedgEntry.SetRange(AgingCustLedgEntry."Customer No.", Customer."No.");
                            AgingCustLedgEntry.SetRange(AgingCustLedgEntry."Posting Date", 0D, EndDate);
                        end;
                    }
                    dataitem(AgingBandLoop; "Integer")
                    {
                        ...
                        trigger OnAfterGetRecord()
                        begin
                            if AgingBandLoop.Number = 1 then begin
            ...
            begin
                ...
                //cc CurrReport.Language := Language.GetLanguageID(Customer."Language Code");
                PrintLine := false;
                Cust2 := Customer;
                Customer.Copyfilter(Customer."Currency Filter", TempCurrency2.Code);
                ...
                if (not PrintLine) and PrintAllHavingEntry then begin
                    ...
                    Customer.Copyfilter(Customer."Currency Filter", CustLedgerEntry."Currency Code");
    ...
    begin
        ...
        //cc//     //cc//LogInteraction :=SegManagement.FindInteractTmplCode(7) <> '';
