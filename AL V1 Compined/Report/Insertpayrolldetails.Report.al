    ...
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(Allowances_Number_; Allowances[Integer.Number])
                {
                }
                column(EarnDesc_Number_; EarnDesc[Integer.Number])
                {
                }
            ...
            begin
                ...
                for i := 1 to NoOfEarnings do begin
                    ...
                    //Muraya exclude accrued gratuity
                    //Assignmat.SETRANGE(Assignmat."Accrued Gratuity",FALSE);
                    //Assignmat.SETRANGE(Assignmat."Negative Earning",FALSE);
