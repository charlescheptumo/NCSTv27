...
Report 69133 "Medical Expenditure -Employee"
{
    //     DefaultLayout = RDLC;
    //     RDLCLayout = './Layouts/Medical Expenditure -Employee.rdlc';
    ...
    //             {
    //             }
    //             column(Employee_Medical_Expenditure_Out_PatientCaption; Employee_Medical_Expenditure_Out_PatientCaptionLbl)
    //             {
    //             }
    ...
    //                 DataItemTableView = sorting("Claim No", "Line No") where("Claim Type" = const("Out Patient"));
    ...
    //                         MedScheme.CalcFields(MedScheme."Out-Patient Claims");
    //                     ExpenseBalline := ExpenseBalline + "Claim Line".Amount;
    //                     // MESSAGE('the balance now is %1',ExpenseBal );
    //                     ExpenseBal := "Medical Scheme Header"."Entitlement -OutPatient" - ExpenseBalline;
    //                 end;
    //             }
    ...
    //         Employee_Medical_Expenditure_Out_PatientCaptionLbl: label 'Employee Medical Expenditure Out-Patient';
