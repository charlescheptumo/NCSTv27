...
Report 65003 "Grantors - Summary Aging"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Grantors - Summary Aging.rdlc';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            column(Customer_No_Caption; Customer.FieldCaption(Customer."No."))
            {
            }
            ...
            begin
                PrintLine := false;
                LineTotalCustBalance := 0;
                Customer.Copyfilter(Customer."Currency Filter", DtldCustLedgEntry."Currency Code");
                for i := 1 to 5 do begin
                    DtldCustLedgEntry.SetCurrentkey("Customer No.", "Initial Entry Due Date");
                    DtldCustLedgEntry.SetRange("Customer No.", Customer."No.");
                    DtldCustLedgEntry.SetRange("Initial Entry Due Date", PeriodStartDate[i], PeriodStartDate[i + 1] - 1);
