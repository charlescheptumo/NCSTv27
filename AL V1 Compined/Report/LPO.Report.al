...
Report 70028 LPO
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                // column(CrossReferenceNo_PurchaseLine; "Purchase Line"."ItemReference No.")
                // {
                // }
                // column(UnitofMeasureCrossRef_PurchaseLine; "Purchase Line"."Unit of Measure (Cross Ref.)")
                // {
                // }
                column(CrossReferenceType_PurchaseLine; "Purchase Line"."Item Reference Type")
                {
                }
                column(CrossReferenceTypeNo_PurchaseLine; "Purchase Line"."Item Reference Type No.")
                {
                }
    ...
    var
        ...
        Conditionslblone: label '     The execution of all or part of this order is subject to the following conditions unless otherwise stated';
        Conditionslbltwo: label 'in writing. A supplier who renders services contrary to these conditions does so at his own risk.';
        Conditionslblthree: label '     1. Tender/Quotation or Contract reference Number and the date must be clearly shown on this form';
        ...
        Conditionslblsix: label '      2. All services are to be carried out strictly in accordance with specifications given No departure is allowed';
        Conditionslblseven: label '          without our prior agreement and in writing.';
        Conditionslbleight: label '      3. Orders must be executed within the period tendered unless instructions are given to the contrary.';
        ...
        Conditionslblten: label '      4. We reserve the right to inspect the service on this order, but such inspection does not relieve the supplier';
        Conditionslbleleven: label '          of his responsibility for defects in material and or/workmanship.';
        Conditionslbltwelve: label '      5. Receipt of this order should be acknowledged on the duplicate copy which should be sent back within ';
        Conditionslblthirteen: label '          7 days.';
