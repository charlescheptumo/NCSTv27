...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/CR1 Copyright Reg Application.rdlc';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Copyright Registration Table"; "Copyright Registration Table")
        {
            ...
            column(No_CopyrightRegistration; "Copyright Registration Table"."No.")
            {
            }
            ...
            column(CopyrightWorkAbstract_CopyrightRegistration; "Copyright Registration Table"."Copyright Work Abstract")
            {
            }
