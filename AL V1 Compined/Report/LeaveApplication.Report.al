...
Report 69073 "Leave Application"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("Document Type", "No.") where("Document Type" = const(8));
            ...
            // column(LeaveType; "Purchase Header"."Leave Type")
            // {
            // }
            // column(NoOfDays; "Purchase Header"."No. Of Days")
            // {
            // }
            // column(From; "Purchase Header"."From Date")
            // {
            // }
            // column("To"; "Purchase Header"."To Date")
            // {
            // }
            // column(BalanceBF; "Purchase Header"."Balance Brought Foward")
            // {
            // }
            // column(BalanceCF; "Purchase Header"."Balance Carried Foward")
            // {
            // }
            column(JobTitle; JobTitle)
            {
            }
            column(EmplDate; EmplDate)
            {
            }
            column(TelNo; TelNo)
            {
            ...
            begin
                ...
                Approval.SETRANGE(Approval."Document Type","Purchase Header"."Document Type"::"Leave Application");
                ...
                IF i=1 THEN BEGIN
                Users.GET(Approval."Sender ID");
                //Users.GET(Approval."Approver ID");
                Users.CALCFIELDS(Picture);
                ...
                */
                ...
                //         i := i + 1;
                //         if i = 1 then begin
                //             Approver[1] := FORMAT(ApprovalEntries."Sender ID");
                ...
                if Emp.Get("Purchase Header"."Request-By No.") then begin
                    JobTitle := Emp."Job Title";
                    EmplDate := Emp."Employment Date";
    ...
    requestpage
    {
        ...
        begin
            ...
            //cc//       //cc//LogInteraction :=SegManagement.FindInteractTmplCode(13) <> '';
