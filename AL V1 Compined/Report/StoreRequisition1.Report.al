...
Report 99096 "Store Requisition1"
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(PreparedBy; "Purchase Header".Approver[1])
            {
            }
            ...
            column(ExaminedBy; "Purchase Header".Approver[2])
            {
            }
            ...
            column(VBC; "Purchase Header".Approver[3])
            {
            }
            ...
            column(Authorizer; "Purchase Header".Approver[4])
            {
            }
                ...
                if DocDim.Find('-') then begin
                    repeat
                        if DocDim."Dimension Code" = 'BRANCH' then
                            "Purchase Header"."Department Name" := DocDim."Dimension Value Code";
