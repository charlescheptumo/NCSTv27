...
Report 90416 "Archived Purchase Order2"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Purchase Header Archive"; "Purchase Header Archive")
        {
            ...
            column(Purchase_Header_Archive_Document_Type; "Purchase Header Archive"."Document Type")
            {
            }
            column(Purchase_Header_Archive_No_; "Purchase Header Archive"."No.")
            {
            }
            column(Purchase_Header_Archive_Doc__No__Occurrence; "Purchase Header Archive"."Doc. No. Occurrence")
            {
            }
            column(Purchase_Header_Archive_Version_No_; "Purchase Header Archive"."Version No.")
            {
            }
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        begin
                            ...
                            RoundLoop.SetRange(RoundLoop.Number, 1, PurchLineArch.Count);
                        end;
                    }
                    ...
                    dataitem(PrepmtLoop; "Integer")
                    {
                        ...
                        dataitem(PrepmtDimLoop; "Integer")
                        {
                            ...
                            column(PrepmtDimLoop_Number; PrepmtDimLoop.Number)
                            {
                            }
            ...
            trigger OnAfterGetRecord()
            begin
                //cc//  CurrReport.Language := Language."Windows Language ID" ("Purchase Header Archive"."Language Code");

                FormatAddressFields("Purchase Header Archive");
                FormatDocumentFields("Purchase Header Archive");
                PricesInclVATtxt := Format("Purchase Header Archive"."Prices Including VAT");

                DimSetEntry1.SetRange("Dimension Set ID", "Purchase Header Archive"."Dimension Set ID");

                "Purchase Header Archive".CalcFields("Purchase Header Archive"."No. of Archived Versions");
            end;
        }
    }
    ...
    begin
        begin
            ...
            ReferenceText := FormatDocument.SetText(PurchaseHeaderArchive."Your Reference" <> '', PurchaseHeaderArchive.FieldCaption(PurchaseHeaderArchive."Your Reference"));
            VATNoText := FormatDocument.SetText(PurchaseHeaderArchive."VAT Registration No." <> '', PurchaseHeaderArchive.FieldCaption(PurchaseHeaderArchive."VAT Registration No."));
        end;
    end;
}
