...
Report 69012 "Master reporterx"
{
    ...
    dataset
    {
        dataitem("Assignment Matrix-X"; "Assignment Matrix-X")
        {
            ...
            begin
                ...
                // CurrReport.SKIP;
                //totalpension:="Assignment Matrix-X"."Employer Amount"+"Assignment Matrix-X".Amount;
    ...
    trigger OnPreReport()
    begin
        //totalpension:="Assignment Matrix-X"."Employer Voluntary"+"Assignment Matrix-X"."Employee Voluntary";
    end;
