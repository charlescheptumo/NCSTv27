...
Table 59649 Applicantr
{
    ...
    fields
    {
        ...
        field(43; "Skills & Competences"; Text[250])
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(55; "Alternative Email"; Text[50])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    begin
        ...
        //HumanResourcesSetup.TESTFIELD(rec."Candida);
        Rec.TestField("Candidate No.");
        if "Candidate No." = '' then
            //NoSeriesMgt.InitSeries(Rec."Candidate No.", xRec."No. Series", 0D, "Candidate No.", "No. Series");
       "Candidate No." := NoSeriesMgt.GetNextNo(Rec."Candidate No.", Today, true);
    end;
