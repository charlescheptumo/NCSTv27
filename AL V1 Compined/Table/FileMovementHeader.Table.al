    ...
    begin
        if "No." = '' then begin
          ...
          //  NoSeriesMgt.InitSeries(GenLedgerSetup."File Movement Nos", xRec."No. Series", 0D, "No.", "No. Series");
            "No." := NoSeriesMgt.GetNextNo(GenLedgerSetup."File Movement Nos", Today, true);
        end;
        ...
        FileMovementLine.SetRange("File Type", "File Number");
        if FileMovementLine.Find('-') then begin
            "File Number" := FileMovementLine."File Type";
            "File Name" := FileMovementLine."File Name";
