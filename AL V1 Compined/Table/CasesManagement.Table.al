...
Table 69502 "Cases Management"
{
    ...
    fields
    {
        ...
        field(8; "Resource#1"; Code[50])
        {
            ...
            begin
                UserMgt.DisplayUserInformation("Resource#1");
            end;
            ...
            begin
                ...
                UserMgt.ValidateUserName(userrec, userrec, "Resource#1");
            end;
        }
        field(9; "Resource #2"; Code[50])
        {
            ...
            var
                UserMgt: Codeunit "User Management";
            begin
                UserMgt.DisplayUserInformation("Resource #2");
            end;
            ...
            begin
                ...
                UserMgt.ValidateUserName(userrec, userrec, "Resource #2");
            end;
        }
        ...
        field(24; "Resource Assigned"; Code[30])
        {
            ...
            var
                UserMgt: Codeunit "User Management";
            begin
                UserMgt.DisplayUserInformation("Resource Assigned");
            end;
            ...
            var
                UserMgt: Codeunit "User Management";
            begin
                UserMgt.ValidateUserName(userrec, userrec, "Resource Assigned");
            end;
        }
        ...
        field(28; "Caller Reffered To"; Code[50])
        {
            ...
            var
                UserMgt: Codeunit "User Management";
            begin
                UserMgt.DisplayUserInformation("Caller Reffered To");
            end;
            ...
            var
                UserMgt: Codeunit "User Management";
            begin
                UserMgt.ValidateUserName(userrec, userrec, "Caller Reffered To");
    ...
    begin
        ...
        if "Enquiry Number" = '' then begin
           ...
           // NoSeriesMgt.InitSeries(HRSetup."Cases nos", xRec."No. Series", 0D, "Enquiry Number", "No. Series");
            "Enquiry Number" := NoSeriesMgt.GetNextNo(HRSetup."Cases nos", Today, true);    
        end;
