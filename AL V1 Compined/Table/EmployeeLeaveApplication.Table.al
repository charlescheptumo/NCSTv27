            ...
            begin
                ...
                if "Days Applied" <> 0 then begin
                    if "Start Date" <> 0D then begin
                        ...
                        repeat
                            //cc//   //cc// if not CalendarMgmt.CheckDateStatus(GeneralOptions."Base Calendar Code", NextWorkingDate, Description) then
                ...
                if "Start Date" <> 0D then begin
                    while NonWorkingDay = false
                      do begin
                        //cc//           NonWorkingDay := CalendarMgmt.CheckDateStatus(HumanResSetup."Base Calender Code");
    ...
    begin
        ...
        if "Application No" = '' then begin
          ...
          //NoSeriesMgt.InitSeries(HumanResSetup."Leave Application Nos.", xRec."No. series", 0D, "Application No", "No. series");
            "Application No" := NoSeriesMgt.GetNextNo(HumanResSetup."Leave Application Nos.", Today, true);
        end;
