...
Table 70027 "Commitee Members"
{
    ...
    fields
    {
        ...
        field(8; Role; Option)
        {
            ...
            OptionCaption = ' Member,Chairperson,Secretariat';
            OptionMembers = " Member",Chairperson,Secretariat;
        }
        field(9; Email; Text[30])
        {
            DataClassification = ToBeClassified;
        }
        field(10; "Opening Person 1"; Code[60])
        {
            DataClassification = ToBeClassified;
        }
        field(11; "Opening Person 2"; Code[60])
        {
            DataClassification = ToBeClassified;
        }
        field(12; "Opening Person 3"; Code[60])
        {
            DataClassification = ToBeClassified;
        }
        field(13; "Nominated Bid Opening"; Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = 'Member 1,Member 2,Member 3';
            OptionMembers = "Member 1","Member 2","Member 3";
        }
    }
