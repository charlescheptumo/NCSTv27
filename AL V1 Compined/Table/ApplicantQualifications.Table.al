...
Table 69203 "Applicant Qualifications"
{
    Caption = 'HR Applicant Qualifications';
    DataCaptionFields = "Employee No.";
    // // DrillDownPageID = UnknownPage39003960;
    ////LookupPageID = UnknownPage39003960;
    ...
    fields
    {
        field(1; "Application No"; Code[10])
        {
            ...
            TableRelation = "Job Position Applications"."Application No";
        }
        ...
        {
            NotBlank = false;
            TableRelation = "HR Models".Code where(Type = filter("Qualification Type"));
        }
        field(15; "Qualification Code"; Text[200])
        {
            NotBlank = true;
            TableRelation = "Employee Qualification"."Qualification Code";// where(Field14 = field("Qualification Type"));
    ...
    var
        HRQualifications: Record "Employee Qualification";
        Applicant: Record "Job Position Applications";
        Position: Code[20];
        JobReq: Record "Job Requirementx";
}
