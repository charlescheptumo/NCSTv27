...
Table 69202 "Job Position Applications"
{
        ...
        field(66; "Employee No"; Code[20])
        {
            ...
            begin
                ...
                if Employee.Get("Employee No") then begin
                    ...
                    "Cell Phone Number" := Employee."Phone No.";
    ...
    begin
        ...
        if "Application No" = '' then begin
         ...
         //   NoSeriesMgt.InitSeries(HRSetup."Job Application No Series", xRec."No. Series", 0D, "Application No", "No. Series");
            "Application No" := NoSeriesMgt.GetNextNo(HRSetup."Job Application No Series", Today, true);
        end;
    ...
    var
        ...
        AppQualifications: Record "Applicant Qualifications";
        AppRefferees: Record "Applicant Referees";
        AppHobbies: Record "HR Job Qualifications";
        HRJobApp: Record "Job Position Applications";
